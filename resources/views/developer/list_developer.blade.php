...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-5 col-8" >
            <h3 class="top-title">Developer List</h3>
        </div>
    </div>
    </div>
                            ...
                            <table class="table table-bordered table-hover table-responsive " id="dataTable" style="max-height:185vh;overflow:scroll;">
                                    ...
                                    <thead style="background: #70cacc;color: aliceblue;">
                                        <tr>
                                            ...
                                            <th><span class="table-title">Photo</span></th>
                                            {{-- <th><span class="table-title">description</span></th> --}}
                                            <th><span class="table-title">Description Image</span></th>
                                            {{-- <th><span class="table-title">user_id</span></th> --}}
        ...
        <script>
            ...
            scrollCollapse: true,
               ...
               $('body').on('click', '.edit', function() {
                    ...
                    $.ajax({
                        type: "Get",
                        url: "{{ route('upnewdeveloper') }}/" + id,
                        dataType: 'html',
                        success: function(result) {
                            window.location.href = "{{ route('upnewdeveloper') }}/" +
                                id;
                        },
                        error: function(erorr) {
                            console.log(erorr);
