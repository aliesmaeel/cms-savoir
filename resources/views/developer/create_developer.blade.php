    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Create Developer</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="file" placeholder="Enter Logo Image" name="image" id="image" 
                            style="background: #fff!important" required>
                    </div>
                </div>
                {{-- banner image --}}
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="file" placeholder="Enter Banner Image" name="photo" id="photo" 
                            style="background: #fff!important" required>
                    </div>
                </div>
                {{-- Description 4 --}}
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="file" placeholder="Enter Description Image" name="description_image" id="description_image" 
                            style="background: #fff!important" required>
                    </div>
                </div>
    ...
    <script>
        $('#buttonsubmit').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('create_new_developer') }}",
                beforeSend: function() {
