...
@push('head')
    ...
    <title>Off-Plan Projects List</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-4 col-md-5 col-8" >
            <h3 class="top-title">Testimonials List</h3>
        </div>
    </div>
    </div>
                            ...
                            <table class="table table-bordered table-hover table-responsive " id="dataTable" style="max-height:185vh;overflow:scroll;">
                                    ...
                                    <thead style="background: #70cacc;color: aliceblue;">
                                        <tr>
                                            ...
                                            <th><span class="table-title">position</span></th>
                ...
                $('body').on('click', '.delete', function() {
                    ...
                    swal({
                        ...
                        if (value) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ route('testimonial_project_delete') }}",
                                data: {
                                    id: id
                                },
                                dataType: 'json',
