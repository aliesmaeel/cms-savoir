    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update Testimonials</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata" enctype="multipart/form-data">
            <div class="container" >
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="holder mt-4">
                            <img id="imgPreview" src="{{ $data->image }}" alt="pic"
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="input_off_plan" placeholder="Enter Name" name="name" id="name"
                               value="{{$data->name}}" required style="border-right: 3px solid #9D865C!important">
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="input_off_plan" placeholder="Enter Position" name="position" id="position"
                               value="{{$data->position}}" required style="border-right: 3px solid #9D865C!important">
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <textarea type="text" class="input_off_plan" placeholder="Enter Description" name="message" id="description" required style="border-right: 3px solid #9D865C!important">
                            {{$data->message}}
                        </textarea>
                    </div>
                </div>
    ...
    <script>
        $('#buttonsubmit').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('testimonial_project_update', $data->id) }}",
                beforeSend: function() {
                ...
                success: function(result) {
                    ...
                    window.location.href = "{{ route('list_testimonials') }}";
                },
