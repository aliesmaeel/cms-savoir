    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Create Country</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Code" name="code" id="slug" required>
                    </div>
                </div>
                <div class="row mt-4 mb-4">
                    <div class="col-md-3">
                        <label class="title-input" for="name">image</label>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('#buttonsubmit').click(function(e) {
            ...
            let singleInnerImageInput = document.getElementById('image');
            if (singleInnerImageInput.files.length > 0) {
                formData.append('image', singleInnerImageInput.files[0]);
            }
