...
@section('wrapper_content')
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update Country</h3>
            </div>
        </div>
    </div>
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <form id="maindata" data-action="{{ route('update_country',$country->id) }}">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Name" value="{{ $country->name }}" name="name" id="name" required>
                    </div>
                </div>
                {{-- //slug --}}
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="name">Code</label>
                    </div>
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Code" name="code" value="{{ $country->code }}"  id="slug" required>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="holder mt-4">
                            <img id="imgPreview" src="{{asset('/storage/'.$country->image)}}" alt="pic" width="100"
                                 height="100"  />
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row mt-4 mb-4">
                    <div class="col-md-3">
                        <label class="title-input" for="name">Show In Home Page</label>
                    </div>

                    <input type="checkbox" @if($country->show_in_home_page) checked @endif   name="show_in_home_page"
                ...
                <div class="row mt-5">
                    <div class="col-md-12 text-center">
                        <button id="buttonsubmit" class="btn " type="button">Update
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        window.location.href = "{{ route('list_countries') }}";
                    } else {
                        $("#alertdata").empty();
