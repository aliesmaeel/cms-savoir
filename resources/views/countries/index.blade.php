    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-5 col-8">
                <h3 class="top-title">List Countries</h3>
            </div>
        </div>
    </div>
            ...
            <div class="container-fluid" style="margin-top:1.5rem">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: right">
                        <input type="button" value="New Country"
                            onclick="location.href='{{ route('create_country') }}'" class="btn btn-primary mr-5">
                    </div>
                </div>
                <div class=" pb-3 mt-3 mb-5" role="alert" id="alertdiv" hidden></div>
