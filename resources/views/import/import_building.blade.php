...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-4 col-md-5 col-8" >
            <h3 class="top-title">Import Building</h3>
        </div>
    </div>
    </div>
	<div id="content-wrapper" class="d-flex flex-column" >
		...
		<div id="width" style="margin: +2rem auto auto auto;">
			...
			<div class="card-body">
				<form action="{{ route('import_building') }}"
					method="POST"
					...
					<button type="submit" id="import" name="save" class="btn btn-primary btn-block">Import
                        <span class=" spinner-create spinner-border spinner-border-sm" role="status"
                                    aria-hidden="true" hidden></span></button>
					</div>
				</form>
			</div>
		</div>
