...
@section('wrapper_content')
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update City</h3>
            </div>
        </div>
    </div>
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <form id="maindata" action="{{ route('update_city',$city->id) }}">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Name" value="{{$city->name  }}" name="name" id="name" required>
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Country</label>
                    </div>
                    <div class="col-md-8">
                        <select name="country_id" id="name">
                            <option value="">Select Country</option>
                            @foreach ( $country as $key)
                            <option value="{{$key->id}}" @if($city->country_id == $key->id) selected @endif>{{$key->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        window.location.href = "{{ route('list_cities') }}";
                    } else {
                        $("#alertdata").empty();
