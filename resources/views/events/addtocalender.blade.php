    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Add to Calender</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Event Title</label>
                    </div>
                    <div class="col-md-8">
                        {{-- {{Auth::user()->name}} --}}
                        <input type="text" placeholder="Enter Event Title" name="event_title" value="" id="name" >
                        <input type="text" placeholder="Enter Event Name" name="event_id" value="{{$id}}"  hidden>

                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Start Time</label>
                    </div>
                    <div class="col-md-8">
                        <input type="time" placeholder="Enter Start Time" name="start_time" value="" id="email" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">End Time</label>
                    </div>
                    <div class="col-md-8">
                        <input type="time" placeholder="Enter End Time" name="end_time" value="" id="phone">
                    </div>
                </div>

                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Event Source</label>
                    </div>
                    <div class="col-md-8">
                        <select name="event_source" id="phone">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <select name="event_type" id="phone">
                ...
                <div class="row mt-5">
                    <div class="col-md-12 text-center">
                        <button id="buttonsubmit" class="btn btn-primary" type="button">Add to Calender
