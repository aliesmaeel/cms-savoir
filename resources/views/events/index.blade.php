    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Create Event</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Event Name" name="name" id="name" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-8">
                        <input type="datetime-local" placeholder="Enter Date And Time" name="date" id="datetimepicker3" >
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Address" name="address" id="phone">
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <textarea placeholder="Enter Description" name="description" id="password"
...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
    ...
    <script>
        ...
        flatpickr("#datetimepicker3", { enableTime: true,dateFormat: "d/m/Y H:m:ss",});
