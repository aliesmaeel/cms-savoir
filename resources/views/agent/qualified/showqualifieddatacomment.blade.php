@extends('layouts.app')
@push('head')
    <title>Qualified comments</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-7 col-11" >
               <h3 class="top-title">Qualified comments</h3>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body mt-3">
                        ...
                        <div class="model">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <input class="form-control" type="text" value=""  name="qualified_id" hidden >
                        ...
                        <div id="div1" class="row mt-5 mb-5 bottom-row " style="justify-content: center;">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Appointment is Suceeded</span></div>
                                    <div class="card-body" style="color: black; background-color: #fff">
                                        <h3 id="appissucceed" class="card-text d-flex justify-content-center">
                                            {{ isset($appissucceed) ? $appissucceed : 0 }}</h3>
                                    </div>
                                </div>
                                <div class="card text-white d-flex justify-content-center"
                                    style="max-width: 12rem; font-size: smaller">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Appointment is Faild</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;border-right: 1px solid #184d47;">
                                        <h3 id="appisfailed" class="card-text d-flex justify-content-center">
                                            {{ isset($appisfailed) ? $appisfailed : 0 }}</h3>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            //////////////////// customer status information show
            ...
            let table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('show_qualified_data_comments') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d) {
                        return $.extend({}, d, {
