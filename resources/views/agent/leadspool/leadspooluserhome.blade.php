                            ...
                            <table class="table table-bordered table-hover" style="width: 300%" id="bookslist">
                                <thead style="background: #70cacc;color: aliceblue;">
                                    <tr>
                                        ...
                                        <th><span class="table-title">Whatsapp Mobile</span></th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#bookslist').DataTable({
                ...
                "dom": 'lftip',
                "ajax": {
                    "url": "{{ route('leads_pool_user_home_data') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d) {
                        return $.extend({}, d, {
        ...
        function btn_click_add_comment(data_id) {
            ...
            if (userstatus == '') {
                ...
                $.ajax({
                    ...
                    url: "{{ route('add_leads_pool_comment') }}",
                    success: function(result) {
                        $("#alertdata").empty();
        ...
        function add_comment(data_id) {
            ...
            if (commentvalue == '') {
                ...
                $.ajax({
                    ...
                    cache: false,
                    data: formData,
                    url: "{{ route('add_comment_more_leads_pool') }}",
                    beforeSend: function() {
