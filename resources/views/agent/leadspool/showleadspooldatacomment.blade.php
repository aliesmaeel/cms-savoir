...
@section('wrapper_content')
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-7 col-11">
                <h3 class="top-title">Leads Comments</h3>
            </div>
        </div>
    </div>
    ...
    @endforeach
                        ...
                        {{-- //////////////////////////data tabe////////////////////////// --}}
                        <div class="alert" role="alert" id="alertdiv1" hidden></div>
                        ...
                        <div class="scroll">
                            ...
                            <div id="div1" class="row mt-5 mb-5 bottom-row " style="justify-content: center;">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Not Answered</span></div>
                                    <div class="card-body" style="color: black;background-color: #fff">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Number & Email Unavailable</span></div>
                                    <div class="card-body" style="color: black;background-color: #fff">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Appointment is set</span></div>
                                    <div class="card-body"
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Wrong Number & Email</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Invalid Number & Email</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Contacted Via Email</span></div>
                                    <div class="card-body"
    ...
    @push('scripts')
                        ...
                        },
                        {
                            ...
                            render: function(data) {
                                if (data != "-" && data != null && data != "") {
                                    return data + '&nbsp&nbsp <a class="wat" href="https://wa.me/' +
                                        data +
        ...
        <script>
            function show_comment(data_id) {
                ...
                $.ajax({
                    url: "{{ route('get_comments_leads_pool') }}/" + data_id ,
                    type: "get",
                    cache: true,
