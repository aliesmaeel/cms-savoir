@extends('layouts.app')
@push('head')
    <title>Proceeded comments</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-7 col-11" >
               <h3 class="top-title">Proceeded comments</h3>
            </div>
        </div>
    </div>
...
<script>
        function show_comments(data_id) {
            ...
            var stage = 5;
            var url = "{{ route('get_comments_proceeded_leads', ['data_id' => '#id1', 'user_id' => '#id2', 'stage' => '#id3']) }}";
