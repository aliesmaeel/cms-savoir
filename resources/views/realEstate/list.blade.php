...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-4 col-md-5 col-8" >
            <h3 class="top-title">Off-Plan Projects List</h3>
        </div>
    </div>
    </div>
                        ...
                        <div class="card-body mt-3">
                            ...
                            <table class="table table-bordered table-hover table-responsive " id="dataTable" style="max-height:185vh;overflow:scroll;">
                                    ...
                                    <thead style="background: #70cacc;color: aliceblue;">
                                        <tr>
                                            <th><span class="table-title">tile</span></th>
                                            <th><span class="table-title">image</span></th>
                                            <th><span class="table-title">pdf</span></th>
                ...
                $('body').on('click', '.delete', function() {
                    ...
                    swal({
                        ...
                        if (value) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ route('real_estate_guides_delete') }}",
                                data: {
                                    id: id
                                },
                                dataType: 'json',
