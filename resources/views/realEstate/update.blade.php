            ...
            <div class="container" >
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="holder mt-4">
                            <img id="imgPreview" src="{{ config('services.cms_link').'/storage/'.$off_plan->image }}" alt="pic" width="100" height="100" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4">
                   ...
                   <div class="col-md-8">
                       <div class="col-12">
                           <label class="file">
                               <input type="file" id="file" name="pdf" class=" mb-5"
                        ...
                        <input type="button"  class="btn btn-md btn-success ml-2 mb-3"
                               value="Download pdf"
                               onclick="location.href='{{route('file.download',['filename'=>$filename]) }}'">
    ...
    <script>
        $('#buttonsubmit').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('real_estate_guides_update', $off_plan->id) }}",
                beforeSend: function() {
                ...
                success: function(result) {
                    ...
                    window.location.href = "{{ route('real_estate_list') }}";
                },
