...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-5 col-8" >
            <h3 class="top-title">Buildings List</h3>
        </div>
    </div>
    </div>
        ...
        <script>
            ...
            scrollCollapse: true,
               ...
               $('body').on('click', '.edit', function() {
                    ...
                    $.ajax({
                        type: "Get",
                        url: "{{ route('upnewbuilding') }}/" + id,
                        dataType: 'html',
                        success: function(result) {
                            window.location.href = "{{ route('upnewbuilding') }}/" +
                                id;
                        },
                        error: function(erorr) {
                            console.log(erorr);
