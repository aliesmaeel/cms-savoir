        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="building_name">Building Name</label>
                    </div>
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Building Name" name="building_name" value="{{ $building->building_name }}" id="building_name" required>
                    </div>
                </div>
    ...
    <script>
        $('#buttonsubmit').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('update_building', $building->id) }}",
                beforeSend: function() {
                ...
                success: function(result) {
                    ...
                    window.location.href = "{{ route('listbuildingindex') }}";
                },
