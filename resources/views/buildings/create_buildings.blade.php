    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Create Building</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Building Name" name="building_name" id="building_name" required>
                    </div>
                </div>
