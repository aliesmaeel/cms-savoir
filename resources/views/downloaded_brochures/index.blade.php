...
@push('head')
    ...
    <title>Downloaded Brochures List </title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-5 col-8" >
            <h3 class="top-title">Downloaded Brochures List </h3>
        </div>
    </div>
    </div>
                        ...
                        <div class="card-body mt-3">
                            ...
                            <!-- <div class="table-responsive" style="max-height:278vh;overflow:scroll"> -->
                                <!-- <table class="table table-bordered table-hover" id="dataTable">
                                     -->
                            <table class="table table-bordered table-hover table-responsive " id="dataTable" style="max-height:185vh;overflow:scroll;width: 100%">
                                    ...
                                    <thead style="background: #70cacc;color: aliceblue;width: 100%">
                                        <tr>
                                            ...
                                            <th><span class="table-title">Brochure Name</span></th>
                ...
                $('body').on('click', '.delete', function() {
                    ...
                    swal({
                        ...
                        if (value) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ route('delete_downloadedBrochure') }}",
                                data: {
                                    id: id
                                },
                                dataType: 'json',
