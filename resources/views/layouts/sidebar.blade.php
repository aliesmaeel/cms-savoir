<nav class="sidebar">
    ...
    <li id="sbitem63">
        ...
        <ul class="off-plan-show63">
            <li id="sbitem63_0"><a href="{{ route('homepage_slider_create') }}"><i class="fas fa-ad"></i>
                    Create Homepage Slider</a></li>
            <li id="sbitem63_0_1"><a href="{{ route('homepage_slider_list') }}"><i class="fas fa-fw fa-table"></i>
                    Homepage Sliders List</a></li>
            ...
            <li id="sbitem63_5"><a href="{{ route('create_listing') }}"><i class="fas fa-ad"></i>
                    Create Listing Syndication</a></li>
            <li id="sbitem63_6"><a href="{{ route('list_listing') }}"><i class="fas fa-fw fa-table"></i>
