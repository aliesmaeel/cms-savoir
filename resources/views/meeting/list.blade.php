    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-5 col-8">
                <h3 class="top-title">Meetings List</h3>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="table-responsive" style="max-height:278vh;overflow:scroll">
                                <table class="table table-bordered table-hover" id="dataTable" style="width: 130%">
                                    <thead style="background: #70cacc;color: aliceblue;">
                                        <tr>
                                            ...
                                            <th><span class="table-title">Absent Agents</span></th>
        ...
        <script>
            function deleteMeeting(id) {
                swal({
                    ...
                    if (value) {
                        var url = "{{ route('delete.meeting', '+id+') }}";
                        $.ajaxSetup({
                            headers: {
