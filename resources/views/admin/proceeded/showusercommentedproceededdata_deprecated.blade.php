@extends('layouts.app')
@push('head')
    <title>Show proceeded data comments</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-10">
                <h3 class="top-title">Show proceeded data comments</h3>
            </div>
        </div>
    </div>
                        ...
                        <div class="scroll">
                            ...
                            <div id="div1" class="row mt-5 mb-5 bottom-row " style="justify-content: center;">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Cancel</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;border-right: 1px solid #184d47;">
                                        <h3 id="cancel" class="card-text d-flex justify-content-center">
                                            {{ isset($cancel) ? $cancel : 0 }}</h3>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                function getcommentsinfo() {
                    $.ajax({
                        url: "{{ route('get_admin_proceeded_data_comments_info') }}",
                        dataType: "json",
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
                ...
                let table = $('#dataTable').DataTable({
                    ...
                    "ajax": {
                        "url": "{{ route('show_proceeded_data_comments') }}",
                        "dataType": "json",
                        "type": "POST",
                        "data": function(d) {
                            return $.extend({}, d, {
...
<script>
            function show_comments(data_id) {
                ...
                var url = "{{ route('get_comments_proceeded_admin', ['data_id' => '#id1', 'agentname' => '#id2']) }}";
