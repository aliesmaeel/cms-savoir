...
@push('head')
    <title>Update Sub-Community</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update Sub-Community</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Community</label>
                    </div>
                    <div class="col-md-8">
                        <select id="community" name="community" class="form-control input-form" required>
                            <option></option>
                            @foreach ($communities as $community)
                                <option {{ $community->id == $subCommunity->community_id ? 'selected' : '' }}
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Community Name" name="name" id="name"
                            value="{{ $subCommunity->name }}" required>
                    </div>
                </div>
                <div class="row mt-5">
...
@push('scripts')
    ...
    <script>
        $('#buttonsubmit').click(function(e) {
            ...
            formData.append("subcommunity_id", "{{ $subCommunity->id }}");
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        location.href = "{{ route('list_subcommunities') }}";
                    } else {
                        $("#alertdata").empty();
                        $("#alertdata").append(
