...
@push('head')
    <title>Show asigned agent to follow up data</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-6 col-md-7 col-11" >
            <h3 class="top-title">Show asigned agent to follow up data</h3>
        </div>
    </div>
    </div>
                ...
                <div class="alert alert-error pb-3 mt-3" id="alertdata" role="alert" hidden>
                    ...
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold" style="color: #70cacc;display:none">
                            Show asigned agent to follow up data
                        </h3>
                        <div class="row mb-1">
...
@push('scripts')
    <script>
        ...
        let table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('show_assigned_agent_follow_up_data') }}",
                "dataType": "json",
                "type": "POST",
                "data": function(d) {
                    return $.extend({}, d, {
        ...
        $(document).ready(function() {
            ...
            $('#unassign_data').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('unassign_agent_follow_up_data') }}",
