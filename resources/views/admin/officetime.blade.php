    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-5 col-8">
                <h3 class="top-title">Office Time</h3>
            </div>
        </div>
    </div>
            ...
            <table class="table table-bordered table-hover" style="width: 200%" id="dataTable">
                <thead style="background: #70cacc;color: aliceblue;">
                    <tr>
                        ...
                        <th><span class="table-title">Yesterday</span></th>
                        <th><span class="table-title">Last Week</span></th>
                        <th><span class="table-title">Last Month</span></th>
                        <th><span class="table-title">This Year</span></th>
