    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-5 col-8">
                <h3 class="top-title">List Communities</h3>
            </div>
        </div>
    </div>
            ...
            <div class="container-fluid" style="margin-top:1.5rem">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: right">
                        <input type="button" value="New Community"
                            onclick="location.href='{{ route('create_new_community') }}'" class="btn btn-primary mr-5">
                    </div>
                </div>
                <div id="parent" class="card shadow mb-4 mt-2">
                    <div class="card-header py-3">
                        ...
                        <div class="card-body mt-3">
                            ...
                            <!-- <table class="table table-bordered table-hover" id="dataTable">
                                                             -->
                            <table class="table table-bordered table-hover " id="dataTable"
                                style="max-height:185vh;overflow:scroll; width: 100%">

                                <thead style="background: #70cacc;color: aliceblue; width: 100%">
                                    <tr>
                                        <th><span class="table-title">id</span></th>
                                        <th><span class="table-title">Image</span></th>
                                        <th><span class="table-title">Inner Image</span></th>
                                        <th><span class="table-title">Name</span></th>
                                        <th><span class="table-title">slug</span></th>
