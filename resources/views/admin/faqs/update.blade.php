    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update FAQ</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata" enctype="multipart/form-data">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3"><label class="title-input" for="title">Question</label></div>
                    <div class="col-md-8">
                        <textarea class="ckeditor" name="question">{{$faq->question}}</textarea>
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3"><label class="title-input" for="title">Answer</label></div>
                    <div class="col-md-8">
...
@push('scripts')
    ...
    <script>
            $('#buttonsubmit').click(function(e){
                ...
                let descriptions = ['answer', 'question'];
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        window.location.href = "{{ route('faq_list') }}";
                    },
