@extends('layouts.app')
@push('head')
    <title>Show leads pool data comments</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-10">
                <h3 class="top-title">Show leads pool data comments</h3>
            </div>
        </div>
    </div>
...
<div class="input-group date mb-3" id="datetimepicker2">
    ...
    @endforeach
                        ...
                        {{-- //////////////////////////data tabe////////////////////////// --}}
                        <div class="alert mt-3" role="alert" id="alertdiv1" hidden></div>
                            ...
                            {{-- <div class="model">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <input class="form-control" type="text" value="" name="leadspool_id" hidden>
                            ...
                            <div id="div1" class="row mt-5 mb-5 bottom-row" style="justify-content: center;">
                                <div class="card text-white bg-primary d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Total calls</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;border-left: 1px solid #184d47;">
                                ...
                                <div class="card text-white bg-primary d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Total Assigned</span></div>
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Not interested</span></div>
                                    <div class="card-body" style="color: black;background-color: #fff">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Number And Email Unavailable</span></div>
                                    <div class="card-body" style="color: black;background-color: #fff">
                                        <h3 id="nuanemun" class="card-text d-flex justify-content-center">
                                            {{ isset($nuanemun) ? $nuanemun : 0 }}</h3>
                                    </div>
                                </div>
                                <div class="card text-white d-flex justify-content-center"
                                    style="max-width: 28rem; font-size: smaller">
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Line busy number</span></div>
                                    <div class="card-body" style="color: black;background-color: #fff">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Set appointment</span></div>
                                    <div class="card-body"
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Wrong Number And Email</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;">
                                        <h3 id="wrnuanem" class="card-text d-flex justify-content-center">
                                            {{ isset($wrnuanem) ? $wrnuanem : 0 }}</h3>
                                    </div>
                                </div>
                                <div class="card text-white d-flex justify-content-center"
                                    style="max-width: 10rem; font-size: smaller">
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Invalid Number And Email</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff">
                                        <h3 id="innuanem" class="card-text d-flex justify-content-center">
                                            {{ isset($innuanem) ? $innuanem : 0 }}</h3>
                                    </div>
                                </div>
                                <div class="card text-white d-flex justify-content-center"
                                    style="max-width: 10rem; font-size: smaller">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp"> Cancelation after appointment </span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;">
                                        <h3 id="caafap" class="card-text d-flex justify-content-center">
                                            {{ isset($caafap) ? $caafap : 0 }}</h3>
                                    </div>
                                </div>
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Mobile Switched off</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;">
                                        <h3 id="moswof" class="card-text d-flex justify-content-center">
                                            {{ isset($moswof) ? $moswof : 0 }}</h3>
                                    </div>
                                </div><div class="card text-white d-flex justify-content-center"
                                    style="max-width: 10rem; font-size: smaller">
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="">Contacted Via Email</span></div>
                                    <div class="card-body"
                                        style="color: black;background-color: #fff;border-right: 1px solid #184d47;">
                                        <h3 id="coviem" class="card-text d-flex justify-content-center">
                                            {{ isset($coviem) ? $coviem : 0 }}</h3>
                                    </div>
                                </div>
                            </div>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                function getcommentsinfo() {
                    $.ajax({
                        url: "{{ route('get_admin_leads_pool_data_comments_info') }}",
                        dataType: "json",
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
                        ...
                        success: function(result) {
                            ...
                            $("#wrnuanem").text(result.wrnuanem);
                            $("#innuanem").text(result.innuanem);
                            $("#caafap").text(result.caafap);
                            $("#paid").text(result.paid);
                            $("#moswof").text(result.moswof);
                            $("#coviem").text(result.coviem);
                ...
                let table = $('#dataTable').DataTable({
                    ...
                    "ajax": {
                        "url": "{{ route('show_leads_pool_data_comments') }}",
                        "dataType": "json",
                        "type": "POST",
                        "data": function(d) {
                            return $.extend({}, d, {
                ...
                //     var leadspool_id = table.row(this.closest('tr')).data()['id'];
                ...
                //     $('input[name="leadspool_id"] ').val(leadspool_id);
                ...
                //     var leadspool_id = $('input[name="leadspool_id"] ').val();
                ...
                //     $.ajax({
                //         type: "post",
                //         url: "{{ route('update_comment_lesads_bool_data') }}",
                //         dataType: 'json',
                //         data: {
                //             // "_token":{{ csrf_token() }},
                //             "leadspool_id": leadspool_id,
                //             "data_id": data_id,
                //             "comment": comm,
                //             "status": status,
        ...
        <script>
            function show_comment(data_id) {
                ...
                var url = "{{ route('get_comments_leads_pool_admin', ['data_id' => '#id1', 'agentname' => '#id2']) }}";
                    url = url.replace('#id1', data_id);
                    url = url.replace('#id2', agentname);
                $.ajax({
                    url: url,
                    type: "get",
                    cache: true,
