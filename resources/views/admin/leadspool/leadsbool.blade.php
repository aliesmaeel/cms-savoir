...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-7" >
            <h3 class="top-title">Your Leads</h3>
        </div>
    </div>
    </div>
                    ...
                    <div class="card-body" style=" width: 96%; margin-left: 2%">
                        ...
                        <div class="row mt-4 mb-5">
                            ...
                            <div class="col-lg-5 col-md-6 col-12 content-input">
                                ...
                                <div class="dropdown">
                                <select id="campaignsource" class="form-control">
                                    <option value="">All</option>
                                    @foreach ($campaignsources as $campaignsource)
                                        <option value="{{ $campaignsource->name }}">{{ ucfirst($campaignsource->name) }}
                                        </option>
                                    @endforeach
                                </select>
                                </div>
                        ...
                        <div class="row mt-4 mb-5">
                            <div class="col-lg-5 col-md-6 col-12 content-input">
                                ...
                                <div class="dropdown">
                                <select id="projects" class="form-control mt-2">
                                    <option value="">All</option>
                            ...
                            <div class="col-lg-2 col-md-2 col-12 content-input">
                        ...
                        <div class=" mt-4 mb-2 mr-5">
                            <div class=" row">
                                ...
                                <div class="mr-1">
                                    <button id="send_email" class= "btn" style="background-color:#9D865C;width:100px;color:#fff">
                                        Send Email
                                    </button>
                                </div>
                                {{-- <div class="mr-1">
                        ...
                        <table class="table table-bordere" style="overflow:scroll;" id="bookslist" width="300%"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="table-title">Utm source</span></th>
                                    <th><span class="table-title">Utm medium</span></th>
                                    <th><span class="table-title">Utm campaign</span></th>
                                    <th><span class="table-title">Utm id</span></th>
                                    <th><span class="table-title">Campaign source</span></th>
                                    <th><span class="table-title">Bedroom</span></th>
                                    <th><span class="table-title">Project</span></th>
                                    <th><span class="table-title">Created date</span></th>
        ...
        <div id="errors" style="display: none;margin:auto;">
          ...
          <div  class="col-md-12 col-12 mt-5">
            <select  class="form-control " id="templet1"
                ...
                <option value="Body">
            <a class="btn dropdown-item" style="margin-top:20px;background-color:#9D865C-;width:100px;color:#fff" type="button" style="color:rgb(18, 15, 15)" id="text_editor">body</a>

                </option>
                <option value="Templet">
                    <a class="btn dropdown-item" style="margin-top:20px;background-color:#9D865C;width:100px;color:#fff" type="button" style="color:rgb(18, 15, 15)" id="te">Template</a>
          ...
          <div  class="col-md-12 col-12 mt-5 ll" style="display: none">
            ...
            <div class="row mt-5">
                <div class="col-md-12 text-center">
                    <button  type="button" class="btn  Send" style="background-color:#9D865C;width:100px;color:#fff">Send</button>
                </div>
            </div>
          </div>
            ...
            <select class="form-control " id="send_sms_selector" style="">
                ...
                <option value="body">
                    <a class="btn dropdown-item"
                        style="margin-top:20px;background-color:#9D865C;width:100px;color:#fff"
            ...
            <div class="row mt-5">
                <div class="col-md-12 text-center">
                    <button type="button" class="btn  Send_sms"
                        style="background-color:#9D865C;width:100px;color:#fff">Send</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete', function() {
                ...
                var phone = table.row(this.closest('tr')).data()['phone'];
                swal({
                    title: 'Are you sure?',
                    text: 'Email: ' + email + ', phone: ' + phone + ' will be permanantly deleted!',
                    icon: 'warning',
                    buttons: ["Cancel", "Yes!"],
                }).then(function(value) {
                    if (value) {
            ...
            $('body').on('click', '.Send', function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "{{ route('sendemailtoleadspool') }}" ,
                    dataType: 'json',
                    data:{
                        "id":id,
                        "body":body,
