...
@push('head')
    <title>Assigned leads pool data</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-11" >
            <h3 class="top-title">Assigned leads pool data</h3>
        </div>
    </div>
    </div>
                ...
                <div class="alert alert-error pb-3 mt-3" id="alertdata" role="alert" hidden>
                    ...
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold" style="color: #70cacc;display:none">
                            Show assigned agent to leads pool data
                        </h3>
                        <div class="row mb-1">
                    ...
                    <div class="card-body mt-3">
                        ...
                        {{-- ////////////////////////////////////////////////////////// --}}
                        <table class="table table-bordered table-hover" style="width: 1000px" id="dataTable">
...
@push('scripts')
    <script>
        ...
        let table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('show_assigned_agent_leads_pool_data') }}",
                "dataType": "json",
                "type": "POST",
                "data": function(d) {
                    return $.extend({}, d, {
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.Change', function() {
                ...
                formData.append("data_leadspool_id", $('input[name="id_data_change"]').val());
                ...
                $.ajax({
                    ...
                    cache: false,
                    data: formData,
                    url: "{{ route('changeclientleadspooldata') }}",
