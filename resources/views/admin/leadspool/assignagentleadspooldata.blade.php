...
@push('head')
    <title>Assign Leads Pool Data</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-5 col-md-7 col-10" >
            <h3 class="top-title">Assign Leads Pool Data</h3>
        </div>
    </div>
    </div>
                ...
                <div id="parent" class="card shadow pb-5 mb-5">
                    ...
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold" style="color: #70cacc;display:none">
                            Assign agent to leads pool data
                        </h3>
...
@push('scripts')
    <script>
        let table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('search_for_agent_leads_pool_data') }}",
                "dataType": "json",
                "type": "POST",
                "data": function(d) {
                    return $.extend({}, d, {
        ...
        $(document).ready(function() {
            ...
            $('#assign_data').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('assign_agent_leads_pool_data') }}",
