    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-6">
                <img src="img/bg-top.png" width="100%">
            </div>
        </div>
        <div class=" mt-4 mb-2 mr-5">
            <div class=" row">
        ...
        <div class="card-body mt-3" style="width: 90%; margin-left: 5%">
            <table class="table table-bordered table-hover" style="width: 200%" id="dataTable">
                <thead style="background: #70cacc;color: aliceblue;">
                    <tr>
                        <th><span class="table-title">User name</span></th>
                        <th><span class="table-title">Total assigned</span></th>
                        <th><span class="table-title">Number of calls</span></th>
                        <th><span class="table-title">Interested</span></th>
                        <th><span class="table-title">Mobile Switched off</span></th>
                        <th><span class="table-title">Not interested</span></th>
                        <th><span class="table-title">Not Answered</span></th>
                        <th><span class="table-title">Appointment is Faild</span></th>
                        <th><span class="table-title">Appointment is Suceeded</span></th>
                        <th><span class="table-title">Others</span></th>
                        <th><span class="table-title">Appointment is set</span></th>
                        <th><span class="table-title">Canceled</span></th>
                        <th><span class="table-title">Paid</span></th>
                        <th><span class="table-title">Cancelation after appointment</span></th>
                        <th><span class="table-title">Invalid Number & Email</span></th>
                        <th><span class="table-title">Wrong Number & Email</span></th>
                        <th><span class="table-title">Number & Email Unavailable</span></th>
                        <th><span class="table-title">Contacted Via Email</span></th>
                        <th><span class="table-title">Line Busy</span></th>
                        <th><span class="table-title">Mobile Switched off</span></th>
    ...
    <script>
        let table = $('#dataTable').DataTable({
            ...
            "columns": [
                ...
                {
                    data: "Appointmentisfailed",
                    width: '300px'
                },
                {
                    data: "Appointmentissucceed",
                    width: '300px'
                },
                {
                    data: "others",
                ...
                {
                    data: "Cancelationafterappointment",
                    width: '100px'
                },
                {
                    data: "InvalidNumberAndEmail",
                    width: '100px'
                },
                {
                    data: "WrongNumberAndEmail",
                    width: '100px'
                },
                {
                    data: "NumberAndEmailUnavailable",
                    width: '100px'
                },
                {
                    data: "ContactedViaEmail",
                    width: '100px'
                },
                {
                    data: "LineBusy",
        ...
        $('body').on('click', '.details', function() {
            ...
            var username = table.row(this.closest('tr')).data()['userid'];
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                type: "Get",
                url: "{{ route('show_details_user_index') }}/" + username,
                success: function(result) {
                    window.location.href = "{{ route('show_details_user_index') }}/" + username;
                },
