    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update Community</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Community Name" name="name" id="name"
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="input_off_plan" readonly
                               placeholder="Generated Automatically !"
                               name="slug" id="slug" required value="{{$community->slug}}">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Inner Image</label>
                    </div>
                    <div class="col-md-8">
                        <input type="file" placeholder="Enter Image" name="inner_image"
                               id="inner_image"
                               style="background: #fff!important">
                        <div class="holder mt-4">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <textarea type="text" class="ckeditor input-form"
                                  placeholder="Enter description"
                                  name="description" id="description" style="background: rgb(255, 255, 255) !important; visibility: hidden; display: none;">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="number"  class="input_off_plan"
                               placeholder="Enter Order" value="{{$community->Order}}" name="Order" id="Order" required>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="input_off_plan"
                          value="{{$community->youtube}}"     placeholder="Enter Youtube link" name="youtube" id="youtube" required>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text"  value="{{$community->location}}"  class="input_off_plan" placeholder="Enter Location" name="location" id="location" required>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        document.getElementById('name').addEventListener('input', function() {
            ...
            const slugValue = nameValue.replace(/\s+/g, '-') + '-community';
    ...
    <script>
        ...
        $('#inner_image').change(function() {
            const file = this.files[0];
            if (file) {
                let reader = new FileReader();
                reader.onload = function(event) {
                    $('#inner_imgPreview').attr('src', event.target.result);
                    $('#inner_imgPreview').attr('hidden', false);
                }
                reader.readAsDataURL(file);
            }
        });
        ...
        $('#buttonsubmit').click(function(e) {
            ...
            let singleInnerImageInput = document.getElementById('inner_image');
            if (singleInnerImageInput.files.length > 0) {
                formData.append('inner_image', singleInnerImageInput.files[0]);
            }
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        location.href="{{ route('list_communities') }}";
                    } else {
                        $("#alertdata").empty();
                        $("#alertdata").append(
