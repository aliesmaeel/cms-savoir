...
#agentname,#propertyname,#username{
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-6" >
            <h3 class="top-title">List payments</h3>
        </div>
    </div>
    </div>
    <div id="content-wrapper" class="d-flex flex-column" >
        ...
        <div id="content">
                            ...
                            <table class="table table-bordered table-hover table-responsive " id="dataTable" style="max-height:185vh;overflow:scroll;">
                                ...
                                <thead style="background: #70cacc;color: aliceblue;">
                                    ...
                                    <th><span class="table-title">id</span></th>
                                        <th><span class="table-title">Buyer name</span></th>
                                        <th><span class="table-title">Property</span></th>
                                        <th><span class="table-title">Payment amount</span></th>
                                        <th><span class="table-title">Payment date</span></th>
                                        <th><span class="table-title">Payment status</span></th>
            ...
            <div class="row bottom-row">
                <div class="col-lg-9 col-md-9 col-12 all-9">
                    <div id="card-bottom"  class="card text-white bg-primary d-flex justify-content-center" >
                    ...
                    <div id="card-bottom"  class="card text-white bg-primary d-flex justify-content-center" >
                        <div class="card-header" style="background: orange!important;border-radius:0!important"><span class="sp">Total payments count</span></div>
                    ...
                    <div id="card-bottom"  class="card text-white bg-primary d-flex justify-content-center" >
                        <div class="card-header" style="background: orange!important;border-radius:0!important"><span class="sp2">Total payments amount</span></div>
