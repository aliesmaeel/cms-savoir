...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-8" >
            <h3 class="top-title">Update Appointment</h3>
        </div>
    </div>
    </div>
    <div id="content-wrapper" class="d-flex flex-column" >
        ...
        <form id="maindata">
            <div class="container">
                ...
                <input type="text" value="{{$appointments->id}}" name="id" hidden>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Date</label>
                    </div>
                    <div class="col-md-8">
                        <input type="date" placeholder="Enter Date" value="{{$appointments->date}}" name="date" id="date">
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-8">
                        <input type="time" placeholder="Enter Time" value="{{$appointments->time}}" name="time" id="time">
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Location" value="{{$appointments->location}}" name="location" id="location"
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Building Name" value="{{$appointments->building_name}}" name="buildingname" id="buildingname"
                            style="background: #fff!important">
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Apartment Number"  value="{{$appointments->apartment_no}}" name="apartmentnumber" id="apartmentnumber"
                            style="background: #fff!important">
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Comment" value="{{$appointments->comment}}" name="comment" id="comment"
                            style="background: #fff!important">
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <select id="photoshoottype" class="form-input" name="photoshoottype">
                            ...
                            <option @if ($appointments->photoshoot_type_id == $photoshoottype->id ) selected @endif value="{{$photoshoottype->id}}">{{$photoshoottype->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <select id="photographer" class="form-input" name="photographer">
                            ...
                            <option @if ($appointments->user_id == $photographer->id ) selected @endif value="{{$photographer->id}}">{{$photographer->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
