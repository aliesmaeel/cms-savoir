...
@push('head')
    <title>Update Global Project</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update Global Project</h3>
            </div>
        </div>
    </div>
    ...
    <script>
        $('#buttonsubmit').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('global_project_update', $data->id) }}",
                beforeSend: function() {
                ...
                success: function(result) {
                    ...
                    window.location.href = "{{ route('list_globals') }}";
                },
