...
@push('head')
    <title>Show assigned agent to qualified data</title>
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-11" >
            <h3 class="top-title">Show assigned agent to qualified data</h3>
        </div>
    </div>
    </div>
                ...
                <div class="alert alert-error pb-3 mt-3" id="alertdata" role="alert" hidden>
                    ...
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold" style="color: #70cacc;display:none">
                            Show assigned agent to qualified data
                        </h3>
                        <div class="row mb-1">
...
@push('scripts')
    <script>
        ...
        let table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('show_assigned_agent_qualified_data') }}",
                "dataType": "json",
                "type": "POST",
                "data": function(d) {
                    return $.extend({}, d, {
            ...
            "buttons": [
                ...
                'selectNone',
                {
                    text: '<span class="fa fa-minus-circle" aria-hidden="true"></span> Unassign',
                    attr: {
                        id: 'unassign_data',
        ...
        $(document).ready(function() {
            ...
            //////////////////////////////////////////////////
            $('#unassign_data').click(function(e) {
                $("#alertdata").empty();
                e.preventDefault();
                var data = [];
                ...
                $.ajax({
                    ...
                    url: "{{ route('unassign_agent_qualified_data') }}",
