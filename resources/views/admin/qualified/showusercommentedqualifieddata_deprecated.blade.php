@extends('layouts.app')
@push('head')
    <title>Show qualified data comments</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-10">
                <h3 class="top-title">Show qualified data comments</h3>
            </div>
        </div>
    </div>
                        ...
                        <div class="scroll">
                            ...
                            <div id="div1" class="row mt-5 mb-5 bottom-row " style="justify-content: center;">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Appointment is succeed</span></div>
                                    <div class="card-body" style="color: black; background-color: #fff">
                                ...
                                <div class="card text-white d-flex justify-content-center"
                                    ...
                                    <div class="card-header"
                                        style="background: orange!important;height: 4rem;border-radius:0!important"><span
                                            class="sp">Appointment is failed</span></div>
                                    <div class="card-body"
...
<script>
            function show_comments(data_id) {
                ...
                var url = "{{ route('get_comments_qualified_admin', ['data_id' => '#id1', 'agentname' => '#id2']) }}";
