...
@push('head')
    <title>Update Homepage Slider</title>
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Update Homepage Slider</h3>
            </div>
        </div>
    </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="holder mt-4">
                            <img id="imgPreview" src="{{ $slider->image }}" alt="pic" width="200" height="100" />
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
    ...
    <script>
        ...
        $('#buttonsubmit').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('homepage_slider_update', $slider->id) }}",
                beforeSend: function() {
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        window.location.href = "{{ route('homepage_slider_list') }}";
                    } else {
                        console.log(result);
                        $("#alertdata").empty();
