    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-5 col-8">
                <h3 class="top-title"> User Details</h3>
            </div>
        </div>
    </div>
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class=" mt-4 mb-2 mr-5">
            <div class=" row">
                ...
                <div >
                    <a class="btn  Call ml-5 mb-4" href="{{route('leader_board_index')}}">Back</a>
                </div>
            </div>
        </div>
        <input type="text" id="userid" hidden value="{{$userid}}">
        <div class="card-body mt-5" style="width: 90%; margin-left: 5%;margin-top:25%">
            <table class="table table-bordered table-hover" style="width: 200%" id="dataTable">
                <thead style="background: #70cacc;color: aliceblue;">
                    <tr>
                        ...
                        <th><span class="table-title">Source name</span></th>
                        ...
                        <th><span class="table-title">Cancel</span></th>
