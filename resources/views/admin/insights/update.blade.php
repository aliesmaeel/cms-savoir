        ...
        <form id="maindata" enctype="multipart/form-data">
            <div class="container" >
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text"  value="{{$insight->title}}"
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" value="{{$insight->slug}}" class="input_off_plan" placeholder="Enter slug" name="slug" id="slug" required style="border-right: 3px solid #9D865C!important">
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Link" name="link" id="link" value="{{ $insight->link }}" required style="border-right: 3px solid #9D865C!important">
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <textarea type="text" class="ckeditor input_off_plan" placeholder="Enter Description" name="description" id="features" required style="border-right: 3px solid #9D865C!important">
                            {{$insight->description}}
                        </textarea>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                        <label class="title-input" for="property">Featured</label>
                    </div>
                    <div class="col-md-8">
