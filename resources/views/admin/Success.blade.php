            ...
            <table class="table table-bordered table-hover" style="width: 200%" id="dataTable">
                <thead style="background: #70cacc;color: aliceblue;">
                    <tr>
                        ...
                        <th><span class="table-title">Assigned</span></th>
                        <th><span class="table-title">Meetings</span></th>
                        <th><span class="table-title">Won</span></th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
