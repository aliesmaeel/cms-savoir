...
@push('head')
    <title>Duplicate Property</title>
    ...
    <style>
        ...
        * {
        ...
        .wrapper .file-upload-multi {
            ...
            overflow: hidden;
            background-image: linear-gradient(to bottom, #ef2027 50%, #FFFFFF 50%);
    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-4 col-md-5 col-9">
                <h3 class="top-title">Duplicate Property</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata" class="" enctype="multipart/form-data">
            <div class="container">
                ...
                <input type="text" class="input-form"
                            name="property_id" id="property_id" value="{{ $newProperty->id }}"
                             hidden>
                <!-- star Row 1-->
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <input type="text" min="0" class="input-form" placeholder="Enter Price"
                            name="price" id="price"
                            @if ($newProperty->price != '') value="{{ number_format($newProperty->price) }}"
                ...
                <div class="row mt-5">
                    <div class="col-md-12 text-center">
                        <button id="buttonsubmit" type="button" class="registerbtn">Duplicate
...
<script>
    $('#buttonsubmit').click(function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('duplicate_property', $newProperty->id) }}",
            beforeSend: function() {
