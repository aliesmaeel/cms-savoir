    ...
    <div class="container-fluid" style="padding-left:0!important">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-8">
                <h3 class="top-title">Create Community</h3>
            </div>
        </div>
    </div>
        ...
        <form id="maindata">
            <div class="container">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" placeholder="Enter Community Name" name="name" id="name" required>
                    </div>
                </div>
                <div class="row mt-4 mb-4" style="align-items: center;">
                    <div class="col-md-3">
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="file" placeholder="Enter Image" name="inner_image"
                               ...
                               style="background: #fff!important">
                        <div class="holder mt-4">
                            <img id="inner_imgPreview" src="#" alt="pic" width="100"
                                 height="100" hidden />
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <textarea type="text" class="ckeditor input-form"
                                  ...
                                  name="description" id="description" style="background: rgb(255, 255, 255) !important; visibility: hidden; display: none;"></textarea>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="number"  class="input_off_plan"
                               placeholder="Enter Order" name="Order" id="Order" required>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="input_off_plan" placeholder="Enter Youtube link" name="youtube" id="youtube" required>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-4" style="align-items: center;">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="input_off_plan" placeholder="Enter Location" name="location" id="location" required>
                    </div>
                </div>
    ...
    <script>
        ...
        $('#buttonsubmit').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('create_new_community') }}",
                beforeSend: function() {
