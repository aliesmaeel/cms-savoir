...
@push('head')
    <title>Assigned imported data</title>
...
.model .select2-selection__rendered{
    width: 600% !important;
}
...
@section('wrapper_content')
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-9" >
            <h3 class="top-title"> Assigned imported data</h3>
        </div>
    </div>
    </div>
                ...
                <div id="parent" class="card shadow mb-4">
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-lg-4 col-md-2 col-4"></div>
                               <div class="col-3">
                            ...
                            <thead style="background: #70cacc;color: aliceblue;">
                                <tr>
                                    ...
                                    <th><span class="table-title">
                                       Unique&nbsp&nbsp<div data-toggle="tooltip" style="display:inline-block"
                                    ...
                                    <th><span class="table-title">
                                       P-number&nbsp&nbsp<div style="display:inline-block" data-toggle="tooltip"
                                    ...
                                    <th><span class="table-title">
                                        DOB&nbsp&nbsp<div style="display:inline-block" data-toggle="tooltip"
                    ...
                    <div class="model">
                        ...
                        <div class="alert  pb-3 mt-3" role="alert" id="error" hidden>
                        </div>
                        <input class="form-control" type="text" value=""  name="id_data_change" hidden >
                        <div  class="col-md-12 col-12 mt-5">
                            <input class="form-control" style="border: 1px solid #9D865C" type="text" value=""  name="agent_change" readonly >
                          </div>

                          <div  class="col-md-12 col-12 mt-5">
                            <select  class="form-control select2" id="change"  style="border: 1px solid #9D865C">
                                <option value="">Select Agent</option>
                                @foreach ($agentnames as $agentname)
                                    <option value="{{ $agentname->id }}">{{ ucfirst($agentname->name)}}</option>
                                @endforeach
                            </select>
                          </div>
                            <div class="row mt-5">
                                <div class="col-md-12 text-center">
                                    <button  type="button" class="btn Change" style="background-color:#9D865C;width:100px;color:#fff">Change</button>
                                </div>
                            </div>
                    </div>
    ...
    <script>
        ...
        let table = $('#dataTable').DataTable({
            ...
            "buttons": [
                ...
                'selectNone',
                {
                    text: '<span class="fa fa-minus-circle" aria-hidden="true"></span>  Change Agent',
                    attr: {
                        id: 'change_agent',
                        class: "btn btn-primary change_agent"
                    }
                }
            ],
            columnDefs: [{
        ...
        $(document).ready(function() {
            //////////////////////////////////////////////////
            $('.select2').select2();
            $('.select2-agent').select2({ dropdownAutoWidth : true });
            ...
            $('#change_agent').click(function(e) {
                ...
                if (data.length > 0) {
                    var user = $('#userid').find(":selected").text();
                    var user_id=$('#userid').val();
                    $('input[name="agent_change"]').val(user);
                    $('.model').css('display', 'block');
                    $('input[name="id_data_change"]').val(data);
                    $('#alertdiv1').empty();
                } else {
                    $('#alertdiv1').empty();
                    $('#alertdiv1').append(
            ...
            $('body').on('click', '.Change', function() {
                ...
                formData.append("data_id", $('input[name="id_data_change"]').val());
                formData.append("user_id_change", $('#change').val());
                $.ajax({
                    method: 'post',
                    processData: false,
                    contentType: false,
                    ...
                    success: function(result) {
                        if (result.success) {
                            ...
                            $('#dataTable').DataTable().draw();
                            $('.model').css('display', 'none');
                            $('input[name="id_data_change"]').val('');
                            $("#error").attr('hidden', true);
                            table.rows().deselect();
                        } else {
                            $("#error").empty();
                            $("#error").append("<div class= 'alert alert-danger'>" + result
                                .message + "</div>");
