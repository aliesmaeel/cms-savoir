...
class DubizzleProperty extends Model implements Feedable
{
    use HasFactory;
    protected $guarded = [];
    ...
    public function toFeedItem(): FeedItem
    {
        ...
        $features_exploded = explode(',',  $NewProperty->private_amenities);
        $features = implode('|', $features_exploded);
    ...
    public static function getFeedDubizzle()
    {
        return DubizzleProperty::all();
    }
    public static function getFeedDubizzlehourly()
    {

        return DubizzleProperty::where('created_at', '>=', Carbon::now()->subDay())
