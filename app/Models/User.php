...
class User extends Authenticatable
{
    ...
    public function proceededdata()
    {
        return $this->belongsToMany('App\Models\ProceededLead', 'user_proceeded_leads', 'user_id', 'proceeded_lead_id');
    }
    ...
    public function userproceededdata()
    {
        return $this->hasMany(UserProceededLead::class, 'user_id', 'id');
    }
    ...
    public function userproceededdatacomment()
    {
        return $this->belongsToMany('App\Models\ProceededLead', 'user_proceeded_leads_comment')->withPivot('user_id','proceeded_lead_id','userstatus');
    }
    ...
    {
        return $this->hasMany(NewProperty::class, 'user_id', 'id');
    ...
    {
        return $this->hasMany(BayutProperty::class, 'user_id', 'id');
    ...
    {
        if (Str::contains(Auth::user()->role_id, '5'))
            return true;
        else
            return false;
    }
    ...
    {
        if (Str::contains(Auth::user()->role_id, '6'))
            return true;
        else
            return false;
    }
    ...
    {
        return $this->hasMany(Developer::class, 'user_id', 'id');
    }
}
